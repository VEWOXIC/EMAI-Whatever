...
class T_self_attention(nn.Module):
    def __init__(self):
        super().__init__()
...
class simple(nn.Module):
    def __init__(self,attention_layer=2,channel_expand=False): # 3层l1 1000+ 7层1400 更多数据7层 697 更大lr可到505
        ...
        self.T_attention=nn.Sequential(*[T_self_attention()]*attention_layer)
    ...
    def forward(self,x): # x [b,c,t]
        ...
        x=self.T_attention(x) # [c,b,t]
        x=x.permute(2,1,0) # [t,b,c]
